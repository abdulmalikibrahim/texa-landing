...
if (isset($_SERVER['HTTP_HOST']))
{
	...
	$config['base_url'] = $protocol.'://'.$_SERVER['HTTP_HOST'].$base_path;
}
else
{
	// CLI context (cron/artisan-like scripts) — no request to infer from.
...
$config['sess_cookie_name'] = 'texa_session';
